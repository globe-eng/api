...
const TypeModel = require('../models/project_typeModel');
...
class Project {
    ...
    async create(data = this.props) {
        try {
            ...
            const folder = `/projects/${newModel.slug}`
            if (data?.files?.image) {
    ...
    async delete(data = this.props) {
        try {
            ...
            await cloudinary.deleteFolder(`projects/${model.slug}`);
    ...
    async getProject(data = this.props) {
        try {
            data = {...data};
    ...
    async getProjects(data = this.props) {
        try {
            data = {...data};
    ...
    async getProjectType(data = this.props) {
        try {
            data = {...data};
    ...
    async createProjectType(data = this.props) {
        try {
            data = {...data};
            const errors = {};
            ...
            console.log("Project > createProjectType:", e)
            return {
                success: false,
                message: 'There was an error, please try again!',
            };
    ...
    async updateProjectType(data = this.props) {
        try {
            data = {...data};
            ...
            //console.log("Project > updateProjectType:", e)
            return {
                success: false,
                message: 'There was an error, please try again!',
            };
    ...
    async deleteProjectType(data = this.props) {
        try {
            data = {...data};
            const errors = {};
            ...
            return {
                success: true,
                message: 'Project type has successfully been deleted',
                //investment: investment
            };
        } catch (e) {
            console.log("Project > deleteProjectType:", e)
            return {
                success: false,
                message: 'There was an error, please try again!',
            };
